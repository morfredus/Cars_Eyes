...
- `esp32s3_n16r8`: ESP32-S3 DevKitC-1 N16R8, NeoPixel Eyes: Left=GPIO3, Right=GPIO6, Status=GPIO48, LCD SPI on 12/11/13 with CS 10, DC 9, RST 8, BL 18, buttons on 0/38/39.
