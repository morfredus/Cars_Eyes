...
| **NeoPixel Eye Left** | 19 | — | OUTPUT | Left 8x8 Matrix |
| **NeoPixel Eye Right** | 22 | — | OUTPUT | Right 8x8 Matrix |
...
- **ESP32 :** 0, 2, 4, 5, 12, 15 (already used or avoided)
...
- **ESP32-S3:** GPIO17 (DAC1, display RST), GPIO18 (DAC2, BUTTON)
